...
class Pelanggan extends CActiveRecord
{
    ...
    /**
     * Fungsi untuk menampilkan data pelanggan di halaman transaksi penjualan
     * contoh cara memanggil fungsi ini : Pelanggan::list_items('Pilih Pelanggan')
     * @param null $title
     * @return array
     */
    public function list_items($title=null)
    {
        $sql = "SELECT CONCAT(id,' - ',nama_pelanggan) AS item FROM ".Yii::app()->db->tablePrefix."pelanggan";
